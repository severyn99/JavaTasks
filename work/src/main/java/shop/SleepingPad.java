...
public final class SleepingPad extends Stuff {
    ...
    public SleepingPad(final Integer id, final String name, final String producer, final int weight, final String material, final double price, final String colour, final double thickness) {
        super(id, name, producer, weight, material, price, StuffType.SLEEPINGPAD);
        this.colour = colour;
