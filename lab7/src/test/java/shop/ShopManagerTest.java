...
public class ShopManagerTest{
    ...
    private static Stuff stuff7 = new CampingClothes("y", "z", 73, "r", 3, "M", "ren", ClothesType.JACKETS);
    ...
    void writeToFile() {
        try {
            StuffsWriter decorationsWriter = new StuffsWriter();
            decorationsWriter.writeToFile(manager.getStuffList());
        } catch (IOException e) {
            e.printStackTrace();
        }
